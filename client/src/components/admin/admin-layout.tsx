...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "채팅 모니터링", href: "/admin/chat", icon: MessageSquare, section: "monitoring" },
    { name: "커뮤니티 관리", href: "/admin/community", icon: UsersIcon, section: "content" },
    { name: "권한 관리", href: "/admin/roles", icon: Shield, section: "system" },
    { name: "채용공고 옵션", href: "/admin/job-options", icon: List, section: "content" },
    { name: "희망 근무 분야", href: "/admin/preferred-industries", icon: Briefcase, section: "content" },
    { name: "스킬 마스터 관리", href: "/admin/skills", icon: Code, section: "content" },
